# Домашнее задание к занятию «Системы контроля версий» - Лукинов Андрей
...
1. Зарегистрируйте аккаунт на [https://github.com/](https://github.com/).
...
В качестве результата отправьте ссылку на [репозиторий](https://github.com/Vndr3w/devops-netology).
