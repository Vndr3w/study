# Домашнее задание к занятию «Основы Git» - Лукинов Андрей
...
*В качестве результата работы по всем заданиям приложите ссылки на ваши репозитории в [GitHub](https://github.com/Vndr3w/devops-netology), [GitLab](https://gitlab.com/vndr3w/devops-netology) и Bitbucket*.
